...
\huge STAT 480: Homework 12 \\ % The assignment title
...
Below is the report for problem 1:

\makebox[\textwidth][c]{\includegraphics[scale=1]{hw12-p1}}

\section*{\variableheghtrulefill[.25ex]\quad Problem 2 \quad\variableheghtrulefill[.25ex]}
Below is the report for problem 2:

\makebox[\textwidth][c]{\includegraphics[scale=1]{hw12-p2}}

\section*{\variableheghtrulefill[.25ex]\quad Problem 3 \quad\variableheghtrulefill[.25ex]}
Below is the report for problem 3:

\makebox[\textwidth][c]{\includegraphics[scale=1]{hw12-p3}}

\newpage
\section*{SAS Code}
\lstinputlisting[language=SAS]{hw12.sas}

\newpage
\section*{SAS Log File}
\lstinputlisting[language=]{listings/hw12_logfile.txt}
