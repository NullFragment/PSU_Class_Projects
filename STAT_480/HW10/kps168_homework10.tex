...
\huge STAT 480: Homework 10 \\ % The assignment title
...
\makebox[\textwidth][c]{\includegraphics[scale=1]{hw10-p1}}

\section*{\variableheghtrulefill[.25ex]\quad Problem 2 \quad\variableheghtrulefill[.25ex]}
Below is the report for problem 2:

\makebox[\textwidth][c]{\includegraphics[scale=1]{hw10-p2}}

\newpage
\section*{SAS Code}
\lstinputlisting[language=SAS]{hw10.sas}

\newpage
\section*{SAS Log File}
\lstinputlisting[language=]{listings/hw10_logfile.txt}
