...
Below is the output from my SAS code in text and an image format.

\lstinputlisting[language=]{listings/hw6_output.txt}

\makebox[\textwidth][c]{\includegraphics[width=.9\paperwidth]{ouput_screenshot}}
\makebox[\textwidth][c]{\includegraphics[width=.9\paperwidth]{ouput_screenshot_cropped}}

\newpage
\section*{SAS Code}
\lstinputlisting[language=SAS]{hw6.sas}

\section*{SAS Log File}
\lstinputlisting[language=]{listings/hw6_logfile.txt}
