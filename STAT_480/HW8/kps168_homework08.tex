...
\huge STAT 480: Homework 8 \\ % The assignment title
...
\lstinputlisting[language=]{listings/hw8_output.txt}


\makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{ouput_screenshot_cropped}}

\newpage
\section*{SAS Code}
\lstinputlisting[language=SAS]{hw8.sas}

\section*{SAS Log File}
\lstinputlisting[language=]{listings/hw8_logfile.txt}
